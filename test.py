...
myclient = pymongo.MongoClient("mongodb+srv://test:test@mycluster-mngl3.mongodb.net/test?retryWrites=true&w=majority")
mydb = myclient["test"]
mycol = mydb["cars"]
...
def recognized_plate(list_char_on_plate, size):
    ...
    mydict = {"vehicleNo": fp, "timestamp": datetime.timestamp(datetime.now())}
